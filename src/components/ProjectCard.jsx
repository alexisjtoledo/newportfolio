                ...
                <Fragment key={item.id}>
                    <div className='project-card' style={{marginLeft: margin, marginRight: margin }} >
                        <div className="project-img">
                            <Slider pictures={item.pictures} quantity={item.picturesQuantity}/>
                        </div>
        ...
        <Fragment>
            {
                data.map(item => 
                    <button 
                        ...
                        onClick={e => item.style === 'disabled' ? {} : handleClick(e, item.link)}
                        key={item.id}
                    >
        ...
        <Fragment>
            {
                techs.map(item => item.used === false ? null 
                    ...
                    >
                            ...
                            {
                                item.id === 'jquery' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#0668AC', color: '#E2E8E8'}}>
                            ...
                            {
                                item.id === 'rnative' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#00D8FF', color: '#2C2F2F'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'php' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#757BB4', color: '#050606'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'flash' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#44211B', color: '#E0202D'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'mssql' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#CFD8DD', color: '#B50404'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'csharp' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#3E2E8C', color: '#E2E8E8'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'net' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#512BD4', color: '#E2E8E8'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'ai' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#2E0202', color: '#F39E38'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'ps' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#071E34', color: '#54A7F8'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'id' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#48021F', color: '#FF3466'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'xd' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#400A35', color: '#ED6FEF'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'pr' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#010657', color: '#979AF7'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
                            {
                                item.id === 'ae' 
                                    ? <div className='tech-logo' style={{backgroundColor: '#010657', color: '#989BF8'}}>
                                        <p className='tech-logo-text'>{item.showName}</p>
                                    </div> 
                                    : null
                            }
